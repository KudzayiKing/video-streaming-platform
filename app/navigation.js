...
const Navigation = () => {
    return(
        ...
        <div className='z-20 fixed top-0 h-12 left-0 right-0 mx-auto shadow-xl flex items-center justify-center  text-sm  text-white w-screen bg-black  bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-50' >
            <Link href={'./'} className='pl-2 pr-2'><p style={cinzel.style} className="text-orange-400 font-semibold pt-0.5 text-lg">STREAMING</p></Link>
